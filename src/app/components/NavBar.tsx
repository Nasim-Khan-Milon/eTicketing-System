...
const Navbar: React.FC = () => {
  ...
  const buttonBase =
    "h-9 px-6 rounded-lg text-sm font-medium transition";

  const loginButton = `${buttonBase} bg-blue-600 text-white hover:bg-blue-700`;
  const logoutButton = `${buttonBase} bg-red-500 text-white hover:bg-red-600`;
  const profileButton = `${buttonBase} bg-gray-200 text-black hover:bg-gray-300`;
        ...
        <div className="flex items-center justify-between h-full px-5">
          ...
          <div className="flex items-center gap-2">
            <Image
              ...
              priority
            />
            <h1 className="text-xl font-bold text-blue-600">TiketBus.id</h1>
          </div>
          ...
          <ul className="hidden md:flex items-center gap-6 text-sm font-medium text-gray-700">
            ...
            <Link href="/bus-schedule">
              <li className="hover:text-blue-600 cursor-pointer">Bus Schedule</li>
            </Link>
            <Link href="/help">
            ...
            <ul className="flex flex-col gap-4 text-center text-gray-700 font-medium">
              ...
              {user && (
                <>
                  <li>
                    <button
                      className={profileButton + " w-full"}
                      onClick={() => {
                        setShowMenu(false);
